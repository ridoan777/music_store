			...
			>
				<div class="flex items-center">
					<img 
						class="rounded-full"
						width="27"
						src="https://yt3.ggpht.com/Km8c0hofbwnxIB3cJSYtDrKMIdh936KUR_hQQOMyw90r95VTKJ7xTOj7H1-TqBAhZJ74X8cDkA=s48-c-k-c0x00ffffff-no-rj"
					>
					<div class="text-white text-[14px] ml-1.5 font-semibold">Ridoan Kabir</div>
					<ChevronDown v-if="!openMenu" @click="openMenu = true" fillColor="#FFFFFF" :size="25" />
					<ChevronDown v-else @click="openMenu = false" fillColor="#FFFFFF" :size="25" />
				</div>
			</button>
		...
		>
			...
			<ul>
				...
				<RouterLink to="/library">
					<MenuItem class="ml-[1px]" :iconSize="23" name="Library" iconString="library" pageUrl="/search" />
				</RouterLink>
			</ul>
		</div>
	</div>
